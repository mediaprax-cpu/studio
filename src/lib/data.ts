...
export const products: Product[] = [
  ...
  { id: '17', name: 'Garden Party Sundress', price: 29.50, category: 'girls', sizes: ['2T', '3T', '4T', '5T'], colors: ['Floral', 'Pink'], imageId: 'product-17', description: 'Perfect for any special occasion, this floral sundress is made from light and airy cotton with a sweet bow detail.' },
  { id: '18', name: 'Little Captain Romper', price: 23.00, category: 'newborn', sizes: ['0-3M', '3-6M'], colors: ['Navy', 'White'], imageId: 'product-18', description: 'Ahoy, little one! This nautical-themed romper is perfect for your baby\'s first adventures, with easy snaps for quick changes.' },
  { id: '19', name: 'Skater Dude Long Sleeve', price: 19.00, category: 'boys', sizes: ['5T', '6', '7', '8'], colors: ['Gray', 'Red'], imageId: 'product-19', description: 'A cool, layered-look tee for your little skater. The comfortable fit is perfect for practicing kickflips or just hanging out.' },
  { id: '20', name: 'Sparkle Star Tights', price: 14.00, category: 'girls', sizes: ['2T', '4T', '6'], colors: ['Silver', 'Gold'], imageId: 'product-20', description: 'Add a touch of sparkle to any outfit with these glittery star tights. Stretchy, soft, and super fun!' }
];
